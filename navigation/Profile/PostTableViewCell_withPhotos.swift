//
//  PostTableViewCell_withPhotos.swift
//  navigation
//
...
class PostTableViewCell_withPhotos: UITableViewCell {
    
    struct ViewModel_withPhotos: ViewModelProtocol {
        var author: String
...
extension PostTableViewCell_withPhotos: Setupable { 
    
    func setup(with viewModel: ViewModelProtocol) {
        guard let viewModel = viewModel as? ViewModel_withPhotos else { return }
